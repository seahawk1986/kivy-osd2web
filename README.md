...
This app has the following dependencies (the debian/ubuntu Package name is in brackets, Ubuntu >= 16.04 has the needed package versions)
 ...
 ```
sudo apt-get install git python3-virtualenv python3-dev python3-pip build-essential fonts-roboto
...
sudo apt-get install python3-pygame python-opengl libgl1-mesa-dev libgles2-mesa-dev
